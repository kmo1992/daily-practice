    ...
    <footer className="attributions">
      ...
      <div className="attributions-entries">
        ...
        <p className="attributions-entry">
          ...
          <Link href="https://www.wholelifechallenge.com/">Whole Life Challenge</Link> years
          ago to create a framework of daily practices. Their stretching videos (requires
          subscription) are a fantastic springboard for a better lifestyle.
        </p>
        ...
        <p className="attributions-entry">
          ...
          app for all your training countdowns.
        </p>
        ...
        <p className="attributions-entry">
          ...
          is an easy read with essential advice for moving through the day with less guilt
          and self-blame.
        </p>
      </div>
